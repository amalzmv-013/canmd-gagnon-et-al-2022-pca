function [numfac,realeval,means,percentiles] = parallel_test(raw,ndatsets,percent,kind,randtype,info)

%ndatsets  = 100  ; % Enter the desired number of parallel data sets here
%percent   = 95  ; % Enter the desired percentile here
% kind: Specify the desired kind of parellel analysis, where:
% 1 = principal components analysis
% 2 = principal axis / common factor analysis
%kind = 2 ;

% randtype: Enter either
...
[ii,jj]=find(realeval<percentiles);
